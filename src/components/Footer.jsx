...
<footer className="bgFooter">
  <div className="mx-auto max-w-3xl px-4 py-0 sm:px-6 lg:px-8">
    ...
    <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
      <li>
        <a className="text-white-700 transition hover:text-gray-700/75" href="#"> Team </a>
      </li>

      <li>
        <a className="text-white-700 transition hover:text-gray-700/75" href="#"> History </a>
      </li>

      <li>
        <a className="text-white-700 transition hover:text-gray-700/75" href="#"> Services </a>
      </li>

      <li>
        <a className="text-white-700 transition hover:text-gray-700/75" href="#"> Projects </a>
      </li>

      <li>
        <a className="text-white-700 transition hover:text-gray-700/75" href="#"> Blog </a>
      </li>
    ...
    <ul className="mt-12 flex justify-center gap-6 md:gap-8">
      ...
      <div className="sm:flex sm:justify-center gap-20 mt-4">
        <p className="text-xs text-white-500">&copy; 2024. Space_Cadets. All rights reserved.</p>
