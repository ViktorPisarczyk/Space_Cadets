    ...
    >
      ...
      <div className="relative mx-auto  max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
        ...
        <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
          <h1 className="text-xl font-extrabold text-start text-white sm:text-5xl">
            Explore the Planets and Find Your{" "}
            <strong className="block font-extrabold"> Next Adventure</strong>
          </h1>
          <p className="mt-4 max-w-lg font-bold text-xs text-white text-start sm:text-xl/relaxed">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus corrupti blanditiis nulla quisquam dicta ea, voluptas consectetur sint quod pariatur ipsum, architecto reiciendis saepe fuga.</p>
