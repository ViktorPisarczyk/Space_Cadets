  ...
  return (
    <div className="h-screen">
      <div className="intro">
        ...
        <p>
          Have a question, or ready to embark on your journey with us? Send your
          message directly to our crew, and we’ll get back to you at warp speed.
          Whether you're exploring new possibilities or need guidance, we're
          here to help your ideas reach for the stars!
        </p>
      </div>
