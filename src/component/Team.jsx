  ...
  return (
    <>
      <div className="intro">
        ...
        <p id="para">
          Welcome to the Space Cadets! We are a group of interstellar explorers,
          each with our unique skills and quirks, united by a passion for
          discovery. From the far reaches of our galaxy, we bring curiosity,
          resilience, and creativity to every cosmic challenge. Whether
          navigating the vast unknown or crafting innovative solutions, we’re on
          a mission to make our mark among the stars. Join us on our journey as
          we boldly go where few have ventured before!
        </p>
      </div>
